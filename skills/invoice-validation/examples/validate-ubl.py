...
# Usage: python validate-ubl.py <invoice.ubl.xml>
#
...
if len(sys.argv) < 2:
    print("Usage: python validate-ubl.py <invoice.ubl.xml>", file=sys.stderr)
    sys.exit(1)
...
resp = requests.post(
    "https://api.invapi.org/api/v1/ubl/validate",
